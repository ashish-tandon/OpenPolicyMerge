...
# API Gateway Individual Startup Script
# This script handles cleanup, rebuild, and startup for the API Gateway
...
rebuild_service() {
    ...
    if [[ -d "src" ]]; then
        ...
        go test ./src/... -v || echo "Tests completed with some failures"
    fi
