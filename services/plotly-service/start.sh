...
# Plotly Service Individual Startup Script
# This script handles cleanup, rebuild, and startup for the plotly service
...
rebuild_service() {
    ...
    # Install plotly-specific dependencies
    echo "Installing plotly-specific dependencies..."
