...
# Health Service Individual Startup Script
# This script handles cleanup, rebuild, and startup for the health service
...
rebuild_service() {
    ...
    # Install health-specific dependencies
    echo "Installing health-specific dependencies..."
    pip install psutil
