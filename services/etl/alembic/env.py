"""
Alembic environment configuration for ETL Service

This file configures Alembic to work with the ETL service database models.
"""
...
from models.data_quality import DataQualityMetric
