...
# Notification Service Individual Startup Script
# This script handles cleanup, rebuild, and startup for the notification service
...
rebuild_service() {
    ...
    # Install notification-specific dependencies
    echo "Installing notification-specific dependencies..."
